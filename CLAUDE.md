...
- [Общий обзор документации](docs/README.md)
- [Добавление проектов](docs/projects.md) — шаблоны, frontmatter, чек-листы для коммерческих и исследовательских проектов
- [Добавление статей блога](docs/blog.md) — шаблоны, стилистика, чек-листы
- [Архитектура проекта](docs/architecture.md) — структура каталогов, компоненты, деплой
